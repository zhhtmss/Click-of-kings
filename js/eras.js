...
const ERAS = [
    ...
    {
        name: "Мегаполис",
        description: "Небоскребы, парки, технологии и зелень создают процветающий мегаполис. Управляйте инфраструктурой и максимизируйте доходы города.",
        resourceName: "Инвестиции",
        minGold: 5000,
        requiredUpgrades: 12,
        clickMultiplier: 5,
        autoMultiplier: 5,
